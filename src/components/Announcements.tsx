...
export const Announcements: React.FC = () => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-gray-100"
    >
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-gray-900">إعلانات الحلقة</h2>
          </div>
          <button
            ...
            >
              {announcements.length === 0 ? (
                ...
                announcements.map((announcement, index) => (
                  ...
                  >
                    <p className="text-gray-700 text-sm leading-relaxed">{announcement}</p>
                  </motion.div>
                ))
              )}
            </motion.div>
